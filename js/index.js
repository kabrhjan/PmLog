...
function onDeviceReady() {
  ...
  function error(err) {
    ...
    console.log(`probleeeeeeemeters.`);
  }

  navigator.geolocation.getCurrentPosition(success, error, options);
  //zde konci geolokace
	
	//zde zacina datum a cas
	...
	console.log(datetime); // toto udela otisk casu ve kterem je to spusteno
	//zde konci datum a cas
	
	
	//zde zacina FILE
var filename = 'cordovavystup ' + (currentdate.getMonth()+1) + '-'+currentdate.getDate() + '-'+currentdate.getHours() + "-" + currentdate.getMinutes() + "-" + currentdate.getSeconds()+'.csv';
...
//										debug_out.innerText = graph_buffer_p1.length;
										...
										//console.log("DEDEK length: "+graph_buffer_p1.length+", Canvas width (calc): "+canvas_width+", Canvas width: "+canvas.width+", Canvas height: "+canvas.height+", Offset: "+graph_offset);
                ...
                //zde mohu pomoci kontroly na ruzne de
